...
INSERT INTO users (user_id, address, date_birth, full_name, password, username, email)
VALUES (1, 'User Address', '2000-01-01', 'User Name', '$2a$10$Iom7deSLgxAxykvuANH2s.KpMy5xWbjgQmcsuiycdJt0UMoQflKaC', 'user', 'user@mail.ru'); -- user // u

INSERT INTO users (user_id, address, date_birth, full_name, password, username, email)
VALUES (2, 'Admin Address', '1990-02-02', 'Admin Name', '$2a$10$dWJyopJqWj/PDxEozd6MzOzTwV.5c2GNoU6hUiou0YOF2CHkfDoZK', 'admin', 'admin@mail.ru'); -- admin // a

INSERT INTO users (user_id, address, date_birth, full_name, password, username, email)
VALUES (3, 'SUPER-Admin Address', '1980-03-03', 'SUPER-Admin Name', '$2a$10$BpTDSlU4gBqocZFn7/t7BuqoFww6wBaqMO5Tot7bvzarZDJJ9xwM2', 'superadmin', 'superadmin@mail.ru'); -- superadmin // s
